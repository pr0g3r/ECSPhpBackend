...
watchEffect(() => {
  ...
  /* console.log(`resends/get_order_count/${dateStart.value}/${dateEnd.value}`); */
  ...
  Promise.all([
    ...
    request.get(`resends/get_warehouse_count/picker/${dateStart.value}/${dateEnd.value}`),
    request.get(`resends/get_warehouse_count/packer/${dateStart.value}/${dateEnd.value}`),
    ...
    request.get(`returns/action_customer_count/${dateStart.value}/${dateEnd.value}`),
    request.get(`returns/action_product_count/${dateStart.value}/${dateEnd.value}`),
    ...
    axios.spread(
      (
        ...
        console.log(resendOrders.data);
        
        /* console.log([
          {order_total: 28, created: '2023-04-11'},
          {order_total: 11, created: '2023-04-12'},
          {order_total: 15, created: '2023-04-13'},
          {order_total: 14, created: '2023-04-14'},
          {order_total: 10, created: '2023-04-15'},
          {order_total: 21, created: '2023-04-17'},
        ]); */
      }
    )
  );
